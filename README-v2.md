...
### 34. Obtener Comentarios por Receta
  ...
  "ingredientes": [
    {
      ...
      "unidadMedida": "Peso|Volumen|Cantidad (requerido)"
    }
  ],
  "cantidadComensales": "Number (requerido)",
  "tags": ["Vegetariano", "Vegano", "etc..."],
  "imagen": "URL (opcional)",
...
- `Peso` (gramos, kilogramos, etc.)
- `Volumen` (litros, mililitros, etc.)
- `Cantidad` (unidades, piezas, etc.)
...
Los principales problemas corregidos:
- Referencias inconsistentes en modelos (Usuario vs User)
- Middleware de autenticación mejorado
- Servicios actualizados con campos correctos
- Rutas reorganizadas para evitar conflictos
- Formato de respuesta estandarizado
- Validaciones mejoradas
- **NUEVO**: Funcionalidad completa de aprobación de recetas
- **NUEVO**: Validaciones completas que coinciden con el modelo
- **NUEVO**: Autorización mejorada (solo autor/admin puede modificar)
